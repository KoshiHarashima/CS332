...
\textbf{Takeaways}\\
Flexible algorithm consistently achieves higher average utility and win rate than Myopic; Myopic overreacts to recent bids. Outcomes move toward mixed-equilibrium predictions (high-value wins; price near $v_L$) as $n$ (and $k$) increase, but do not converge to an exact equilibrium strategy profile.
\end{shaded}
...
\begin{figure}[t]
\centering
\newcommand{\imgH}{0.19\textheight} % tweak 0.18–0.20 if needed

% Row 1
\begin{minipage}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth,height=\imgH,keepaspectratio]{332Project3/figures/empirical_vs_ew_bid_evolution.png}
  \caption*{\footnotesize (1) Myopic vs Flexible — Bid}
\end{minipage}\hfill
\begin{minipage}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth,height=\imgH,keepaspectratio]{332Project3/figures/empirical_vs_ew_regret.png}
  \caption*{\footnotesize (2) Myopic vs Flexible — Regret}
\end{minipage}
...
\begin{minipage}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth,height=\imgH,keepaspectratio]{332Project3/figures/optimal_lr_vs_3x_optimal_lr_bid_evolution.png}
  \caption*{\footnotesize (3) Flexible (3×lr) vs Flexible (lr) — Bid}
\end{minipage}\hfill
\begin{minipage}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth,height=\imgH,keepaspectratio]{332Project3/figures/optimal_lr_vs_3x_optimal_lr_regret.png}
  \caption*{\footnotesize (4) Flexible (3×lr) vs Flexible (lr) — Regret}
\end{minipage}
...
\begin{minipage}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth,height=\imgH,keepaspectratio]{332Project3/figures/ew_vs_ew_with_different_values_bid_evolution.png}
  \caption*{\footnotesize (5) Flexible vs Flexible (different $v$) — Bid}
\end{minipage}\hfill
\begin{minipage}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth,height=\imgH,keepaspectratio]{332Project3/figures/ew_vs_ew_with_different_values_regret.png}
  \caption*{\footnotesize (6) Flexible vs Flexible (different $v$) — Regret}
\end{minipage}
...
\begin{minipage}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth,height=\imgH,keepaspectratio]{332Project3/figures/ew_vs_exploitation_for_detail_bid_evolution.png}
  \caption*{\footnotesize (7) Flexible vs Exploitation — Bid}
\end{minipage}\hfill
\begin{minipage}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth,height=\imgH,keepaspectratio]{332Project3/figures/ew_vs_exploitation_for_detail_regret.png}
  \caption*{\footnotesize (8) Flexible vs Exploitation — Regret}
\end{minipage}
\end{figure}
