...
\begin{minipage}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth,height=\imgH,keepaspectratio]{ew_vs_ew/bid_evolution.png}
  \caption*{\footnotesize (1) Myopic vs Flexible — Bid}
\end{minipage}\hfill
\begin{minipage}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth,height=\imgH,keepaspectratio]{ew_vs_ew/regret.png}
...
\begin{minipage}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth,height=\imgH,keepaspectratio]{optimal_lr_vs_3x_optimal_lr/bid_evolution.png}
  \caption*{\footnotesize (3) Flexible (3×lr) vs Flexible (lr) — Bid}
\end{minipage}\hfill
\begin{minipage}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth,height=\imgH,keepaspectratio]{optimal_lr_vs_3x_optimal_lr/regret.png}
...
\begin{minipage}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth,height=\imgH,keepaspectratio]{ftl_vs_ew/bid_evolution.png}
  \caption*{\footnotesize (7) Flexible vs Exploitation — Bid}
\end{minipage}\hfill
\begin{minipage}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth,height=\imgH,keepaspectratio]{ftl_vs_ew/regret.png}
