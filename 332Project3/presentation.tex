...
\begin{frame}{Part 1 Results: Flexible(OPT lr) vs Flexible(OPT lr)}
  ...
  \end{minipage}
    %%% TAKEAWAYS HERE %%%
    \begin{itemize}
        \item players with same values and same strategy(learning rate) 
        \item Due to random differences in early rounds, the learning dynamics diverge into two possible trajectories (the blue and orange lines).
        \item These outcomes are not related to the Nash equilibrium itself, but both show a consistent tendency for bids to gradually increase over time.
    \end{itemize}
\end{frame}
...
\begin{frame}{Part 1 Results: Myopic vs Flexible(OPT lr)}
  ...
  \end{minipage}
    %%% TAKEAWAYS HERE %%%
    \begin{itemize}
        \item Flexible achieves lower regret and higher win rate across MC runs
