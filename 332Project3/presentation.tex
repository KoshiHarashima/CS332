...
\begin{frame}{Part 1 Results: Flexible(OPT lr) vs Flexible(OPT lr)}
  ...
  \end{minipage}
    %%% TAKEAWAYS HERE %%%
    \begin{itemize}
        \item players with same values and same strategy 
    \end{itemize}
\end{frame}
...
\begin{frame}{Robustness}
  \begin{itemize}
    ...
    \item No pure NE in complete-info FPA except for bidding strategy of b = v because both players have incentive to deviate from NE to bid higher as long as below value.
  \end{itemize}
\end{frame}
