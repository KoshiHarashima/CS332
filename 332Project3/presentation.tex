...
\begin{frame}{Part 2 Results: Exploiting Fixed-Lowering Opponent}
  \begin{minipage}[t]{0.48\linewidth}
    \centering
    \includegraphics[width=\linewidth]{ftl_vs_ew/bid_evolution.png}
    \vspace{0.3em}
    \small Bid
  \end{minipage}\hfill
  \begin{minipage}[t]{0.48\linewidth}
    \centering
    \includegraphics[width=\linewidth]{ftl_vs_ew/regret.png}
    \vspace{0.3em}
    \small Regret
  \end{minipage}
    %%% TAKEAWAYS HERE %%%
...
\begin{frame}{Suppelemtary : Battle of Sexes}
  \begin{itemize}
    \item Battle of Sexes:
    \begin{itemize}
      \item Two players, each with two strategies and payoff matrix:
      \begin{align*}
        \begin{pmatrix}
          2 & 0 \\
          0 & 4
...
\begin{frame}{Suppelemtary : Battle of Sexes Results}
  \begin{itemize}
    \item Results:
    \begin{itemize}
      \item Flexible vs Flexible:
      \includegraphics[width=\linewidth]{flexible_vs_flexible_battle_of_sexes/flexible_vs_flexible_battle_of_sexes_action_profile_frequencies.png}
      \item FTL vs Flexible:
      \includegraphics[width=\linewidth]{ftl_vs_flexible_battle_of_sexes/ftl_vs_flexible_battle_of_sexes_action_profile_frequencies.png}
    \end{itemize}
    \item Takeaways:
    \begin{itemize}
...
\begin{frame}{Suppelemtary : Battle of Sexes Results}
  \begin{itemize}
    \item Results:
    \begin{itemize}
      \item Flexible vs Empirical:
      \includegraphics[width=\linewidth]{flexible_vs_empirical_battle_of_sexes/flexible_vs_empirical_battle_of_sexes_action_profile_frequencies.png}
      \item FTL vs Empirical:
      \includegraphics[width=\linewidth]{ftl_vs_empirical_battle_of_sexes/ftl_vs_empirical_battle_of_sexes_action_profile_frequencies.png}
    \end{itemize}
  \end{itemize}
  \item Takeaways:
  \begin{itemize}
