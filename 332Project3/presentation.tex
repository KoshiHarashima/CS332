...
\begin{frame}{Part 1 Results: Flexible(FTL) vs Flexible(OPT lr)}
  \begin{minipage}[t]{0.48\linewidth}
    \centering
    \includegraphics[width=\linewidth]{332Project3/figures/ftl_vs_ew_bid_evolution.png}
    \vspace{0.3em}
    \small Bid
  \end{minipage}\hfill
  \begin{minipage}[t]{0.48\linewidth}
    \centering
    \includegraphics[width=\linewidth]{332Project3/figures/ftl_vs_ew_regret.png}
    \vspace{0.3em}
    \small Regret
  \end{minipage}
    %%% TAKEAWAYS HERE %%%
...
\begin{frame}{Part 1 Results: Flexible(Uniform Guess) vs Flexible(OPT lr)}
  \begin{minipage}[t]{0.48\linewidth}
    \centering
    \includegraphics[width=\linewidth]{332Project3/figures/uniform_guessing_vs_ew_bid_evolution.png}
    \vspace{0.3em}
    \small Bid
  \end{minipage}\hfill
  \begin{minipage}[t]{0.48\linewidth}
    \centering
    \includegraphics[width=\linewidth]{332Project3/figures/uniform_guessing_vs_ew_regret.png}
    \vspace{0.3em}
    \small Regret
  \end{minipage}
    %%% TAKEAWAYS HERE %%%
...
\begin{frame}{Robustness}
  \begin{itemize}
    ...
    \item No pure NE in complete-info FPA, because each time both players have incentive to deviate from NE to bid higher as long as below value.
  \end{itemize}
\end{frame}
...
\begin{frame}{Part 2 Results: Exploiting Fixed-Lowering Opponent}
    \centering
    % Maybe we break these graphics into multiple slides %
    \includegraphics[width=\linewidth,height=0.6\textheight,keepaspectratio]{flexible_vs_exploitation_(part_2).png}
    \vspace{0.8em}
    %%% TAKEAWAYS HERE %%%
    % \begin{itemize}
    %     \item
