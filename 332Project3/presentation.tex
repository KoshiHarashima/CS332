...
\begin{frame}{Part 1 Results: Myopic vs Flexible}
    \centering
    % Maybe we break these graphics into multiple slides? It's a little crowded with the takeaways %
    \includegraphics[width=\linewidth,height=0.6\textheight,keepaspectratio]{myopic_vs_flexible.png}
    \vspace{0.6em}
    %%% TAKEAWAYS HERE %%%
    \begin{itemize}
